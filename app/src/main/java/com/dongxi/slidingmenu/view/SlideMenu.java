package com.dongxi.slidingmenu.view;
...
//				//关闭菜单
        ...
        return true;//拦截TouchMove，不让ScrollView处理该次move事件,会造成ScrollView无法滑动
    }
     ...
     * Scroller不主动去调用这个方法
     * 而invalidate()可以掉这个方法
     * 调用顺序：invalidate->draw->computeScroll
     */
    @Override
